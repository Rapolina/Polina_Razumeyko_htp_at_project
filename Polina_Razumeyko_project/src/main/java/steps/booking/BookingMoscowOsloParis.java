...
public class BookingMoscowOsloParis {
    ...
    public void getPages() {
       ...
       mainBookingPages = new MainBookingPages(Driver.getDriver());
        detailsBookingPagesPage = new DetailsBookingPages(Driver.getDriver());
    }
    ...
    public void IFilterHotelsWithLowestPrice (){
       ...
       realPriceMoscow = detailsBookingPagesPage.getMinPriceMoscow();
    }
